...
public class ResourceConverter {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File rootDir = new File("./sample/registry-operator");
            if (!rootDir.isDirectory()) {
                System.out.println(rootDir.getCanonicalPath() + " is not directory");
                return;
            }

            File outputDir = new File(rootDir, String.valueOf(System.currentTimeMillis()));
            if (!outputDir.exists()) {
                outputDir.mkdir();
            }


            System.out.println("working dir: " + rootDir.getCanonicalPath());
            System.out.println("output dir: " + outputDir.getCanonicalPath());

            // schema json 파일만 걸러냄
            File[] jsonFiles = rootDir.listFiles(new FileFilter() {
            ...
            // CRD yaml 파일만 걸러냄
            File[] yamlFiles = rootDir.listFiles(new FileFilter() {
